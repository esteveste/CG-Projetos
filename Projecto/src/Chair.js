...
var Chair = function () {
    ...
    for (let i = 0; i < 2; i++) {
        ...
        var chairWheelSupp = new THREE.Mesh(cwsgeo, this.material);
    ...
    for (let i = 0; i < 4; i++) {
        ...
        var chairWheel = new THREE.Mesh(cwgeo, this.material);
